      ...
      <div className="relative h-[70vh] w-full max-w-lg rounded-lg bg-white p-6 shadow-xl">
        ...
        <div className="mt-6 flex justify-end gap-4">
          <button
            ...
            className="hover:cursor-pointer rounded bg-gray-100 border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200"
          >
            Отказ
          </button>
          <button
            ...
            className="hover:cursor-pointer rounded bg-blue-600 border border-gray-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700"
          >
            Потвърди
          </button>
        </div>
