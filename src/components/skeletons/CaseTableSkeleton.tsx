// src/components/skeletons/CaseTableSkeleton.tsx
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {Array.from({ length: rows }).map((_, index) => (
              <tr key={index} className="animate-pulse">
                <td className="w-24 px-3 py-4 whitespace-nowrap text-sm text-gray-500 border-b border-gray-200 h-[73px]">
                  <div className="bg-gray-200 rounded w-5/6 h-6" />
                </td>
                ...
                <td className="w-32 px-3 py-4 whitespace-nowrap text-sm text-gray-500 border-b border-gray-200">
                  <div className="bg-gray-200 rounded w-1/2 h-6" />
                </td>
                <td className="max-w-[150px] px-3 py-4 text-sm break-words">
                  <div className="bg-gray-200 rounded w-2/3 h-6" />
                </td>
                ...
                <td className="w-16 px-3 py-4 whitespace-nowrap text-sm text-gray-500 border-b border-gray-200">
                  <div className="bg-gray-200 rounded w-6 h-6 mx-auto" />
                </td>
              </tr>
            ))}
          </tbody>
